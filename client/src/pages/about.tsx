          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <Card className="bg-white dark:bg-accent border-primary-100 dark:border-accent-700">
              ...
              <CardContent>
                ...
                <ul className="text-accent-700 dark:text-primary-200 mb-4 list-disc pl-5">
                  <li>Author name</li>
                ...
                <p className="text-accent-700 dark:text-primary-200 mt-4">
                  For example, to cite <Link to="/documents/a-spirit-of-purpose" className="text-highlight">A Spirit of Purpose</Link>, you might use the following citation:
                </p>
